    	...
    	if (correct) {
	     ...
	     //    }, 2000);
	        ...
	        setTimeout(function() {
		        parent.postMessage({
		            type: 'chat-box-message',
		            message: "As far as we know it's probably a operation against the government, " + 
		            "but it doesn't seem like it's based on our targets usual pattern of operation. I'll do some research on this.",
		        }, '*');
	        }, 6000);
