...
*/
    ...
    var tasks = [
        "You intercepted an encrypted message between the operation leader and one of their" +
        " informants. Break the cipher to get more information on the informant. Be careful though, if there are too many" +
        ...
        "Your job is to choose good phishing email (subject options) to get the operation leader's zmail password. Make sure to select the phishing email which will not raise any suspision. Use the credentials to access their Fakebook page.",
    ...
    function sendMessage(messageText) {
        ...
        */
        $('<div class="message loading new"><figure class="avatar"><img src="https://www.clipartmax.com/png/middle/119-1198197_anonymous-person-svg-png-icon-free-download-anonymous-icon-png.png" /></figure><span></span></div>').appendTo($('.mCSB_container'));
        updateScrollbar();

        setTimeout(function() {
            $('.message.loading').remove();
            $('<div class="message new"><figure class="avatar"><img src="https://www.clipartmax.com/png/middle/119-1198197_anonymous-person-svg-png-icon-free-download-anonymous-icon-png.png" /></figure>' + messageText + '</div>').appendTo($('.mCSB_container')).addClass('new');
            setDate();
            updateScrollbar();
